...
> **[View the CI/CD pipeline run on GitHub Actions](https://github.com/Yash-0702/auction-simulator/actions/runs/23847536163)** — includes build logs, server output, race detection results, and downloadable auction artifacts across multiple resource configurations.
